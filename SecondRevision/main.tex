...
\begin{abstract}
We investigate inductive types in type theory, using the insights provided by homotopy type theory and univalent foundations. We do so by introducing the new notion of a homotopy-initial algebra,
which is obtained from the standard notion of an initial algebra by replacing the usual existence and uniqueness property by a purely type-theoretic contractibility condition. Our main result characterises the types that are equivalent to $\W$-types as homotopy-initial algebras. 
...
the paper in Section~\ref{section:conclusion} oulining some directions for future research.
...
proof that an inductive $P$-algebra is homotopy-initial. \smallskip
 ...
 \noindent
 \emph{Acknowledgements for Nicola Gambino.}   This work was supported by the National Science Foundation 
under agreement No.\ DMS-0635607. This material is based on research sponsored by the Air Force Research Laboratory, under agreement 
number FA8655-13-1-3038. This research was supported by a grant from the John Templeton Foundation.This research was supported by an EPSRC grant (EP/M01729X/1). 
...
Research Office is gratefully acknowledged, as is the support of the Air Force OSR through MURI Grant Number FA9550-15-1-0053.
