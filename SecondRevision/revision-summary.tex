...
However, we have added a remark (Remark 4.1 of the revised version) to explain which proofs would simplify if the judgemental $\eta$-rule for $\Sigma$-types is assumed (along the lines suggested by the referee).
