...
category theory, where standard-category theoretic universal properties are generalized using the topological
 ...
 algebras in
 this paper, let us mention that it would be of interest to relate it with the interpretation of
 $\W$-types in the simplicial model of type theory presented in~\cite{vandenBergMoerdijk:Wtypes}. 
